...
const TopMovies = () => {
    ...
    return (
        <section
            className="mt-4 mb-6 scroll-margin-top bg-black bg-contain bg-bottom bg-no-repeat py-8 md:py-10 lg:py-14"
            // style={{
        ...
        >
            <div className="mx-auto w-full max-w-6xl px-5 md:px-8 lg:px-8">
                <div className="mb-5 text-center md:mb-8">
                    <h2 className="relative text-pink-600 z-2 font-bold text-2xl lg:text-3xl">
                        Nổi bật
                    </h2>
                </div>
                                    ...
                                    <SwiperSlide key={movie.id}>
                                        ...
                                        <div className="mt-2">
                                            <p className="group">
                                                ...
                                                <div className="mt-1 truncate text-tiny sm:text-md leading-tight text-pink-600 group-hover:text-pink-400">
                                                    Đã bán: {movie.ticketCount} vé
                                                </div>
                                            </p>
                                        </div>
